    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            'flex w-[260px] items-center justify-between rounded-md border border-primary bg-card p-2.5 text-gray-500 hover:bg-white-900 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-50',
            triggerClassName,
          )}
        >
          {value ? (
