...
const DETAIL2_OPTIONS = [
  {
    value: 0,
    label:
      'Fatico a fidarmi degli altri o a esprimere i miei sentimenti in modo chiaro',
  },
  {
    value: 1,
    label:
      'Le relazioni affettive sono per me una fonte di stress o confusione',
  },
  {
    value: 2,
    label:
      'Tendo a dipendere molto dagli altri o a temere fortemente il rifiuto',
  },
  {
    value: 3,
    label:
      'Ho sbalzi d’umore legati alla relazione (passaggio da esaltazione a rabbia)',
  },
  {
    value: 4,
    label:
      'Mi sento spesso solo/a anche se sono in una relazione o circondato/a da persone',
  },
];
