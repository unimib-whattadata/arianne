            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  {...field}
                  value={field.value ?? ''}
                  className="bg-secondary-light mt-10 w-full rounded-lg border-none px-6 py-8 !text-lg focus-visible:ring-0 focus-visible:outline-none active:border-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                />
              </FormControl>
            </FormItem>
          )}
