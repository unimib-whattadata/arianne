...
const OPTIONS = [
  ...
  },
  {
    ...
    icon: <UsersRound className="text-primary h-6 w-6" />,
    modalContent:
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="relative w-full max-w-md rounded-2xl bg-white p-20 shadow-xl">
            <Button
              ...
              variant="outline"
              className="border-secondary text-secondary hover:bg-secondary absolute top-6 right-6 rounded-full px-2 transition-colors hover:text-white"
            >
              <X />
            </Button>
