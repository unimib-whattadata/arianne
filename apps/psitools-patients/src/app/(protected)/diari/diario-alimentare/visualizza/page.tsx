...
const fieldLabels: Record<string, string> = {
  ...
  WhatPostConsumerEmotion: 'Quale emozione post consumo',
...
export default function ViewDiary() {
  ...
  const handleBack = () => {
    router.push('/diari/diario-alimentare');
  };
  ...
  interface DiaryContent {
    ...
    WhatPostConsumerEmotion: string;
