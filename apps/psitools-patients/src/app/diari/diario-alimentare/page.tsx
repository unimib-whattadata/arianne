  ...
  const createDiary = useMutation(
    api.diary.create.mutationOptions({
      onSuccess: (data) => {
        ...
        router.push(`/diari/diario-alimentare/compilazione?id=${data.id}`);
      },
    }),
  );

  const back = () => router.push('/diari');
                    ...
                    <CardFooter className="flex justify-end">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          router.push(
                            `/diari/diario-alimentare/compilazione?id=${diary.id}`,
                          );
                        }}
                        className="flex items-center gap-2"
                      >
                ...
                <Card key={diary.id} className="overflow-hidden">
                  ...
                  <CardFooter className="flex justify-end">
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/diari/diario-alimentare/visualizza?id=${diary.id}`,
                        )
                      }
                      className="flex items-center gap-2"
                    >
