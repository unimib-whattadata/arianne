...
import type { FormData } from '@/app/diari/diario-cognitivo-comportamentale/compilazione/layout';
import {
  FormControl,
  FormField,
  FormItem,
    ...
    <div className="space-y-10 p-4">
      ...
      {control._formValues.bodyEmotion === 'Si' && (
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <div className="grid grid-cols-2 items-center gap-10 rounded-sm bg-card px-4 py-6">
                <FormLabel className="text-base font-normal text-gray-900">
