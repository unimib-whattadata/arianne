        ...
        {messages.length > 0 &&
          messages.map((message, index) => {
            ...
            return (
              <Fragment key={index}>
                {isNewDay && (
                  <div className="sticky top-0 z-10 my-6 flex justify-center">
                    <span className="min-w-24 rounded-full bg-gray-200 px-3 py-1 text-center text-xs text-gray-600 shadow">
                ...
                <ChatBubble
                  ...
                  variant={
                    message.senderType === 'patient' ? 'sent' : 'received'
                  }
                >
                  <Avatar>
