...
export const PQ16Item = (props: Props) => {
  ...
  return (
    <div className="mb-2 grid grid-cols-[1fr,auto]">
      <div className="border-white mr-4 grid grid-cols-[1fr,auto] rounded-md border bg-white-900 p-4 transition-colors duration-300">
        <FormLabel>
              ...
              <FormItem className="flex items-stretch space-y-0">
                <FormControl>
                  <RadioGroup
                    ...
                    className={cn(
                      'border-white mt-0 flex shrink-0 rounded-md border bg-white-900 p-4 transition-colors duration-300',
                      questionValue === 'false' &&
                        'cursor-not-allowed border-slate-200 bg-card',
                    )}
                  >
