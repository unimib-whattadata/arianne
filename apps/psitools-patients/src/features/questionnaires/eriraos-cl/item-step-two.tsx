...
export const ItemStepTwo = (props: Props) => {
  ...
  return (
    <>
      <div className="rounded-md bg-card p-4 transition-colors duration-300">
        <FormLabel>
          <div className="space-y-2 pb-2">
            <h3 className="text-space-gray text-base">
            ...
            render={({ field }) => {
              return (
                <FormItem className="w-full pb-2">
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="border-border bg-white-900 text-sm">
              ...
              <FormItem className="w-full">
                <FormControl>
                  <Textarea
                    ...
                    className={cn(
                      'border-white rounded-md border bg-white-900 p-4 transition-colors duration-300',
