...
export const DatePicker = (props: InputProps) => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="font-default border-primary relative z-50 w-auto overflow-hidden rounded-md border bg-gray-10 p-0 text-popover-foreground animate-in fade-in-80">
        <Calendar
          mode="single"
          selected={selected}
          onSelect={onSelect}
