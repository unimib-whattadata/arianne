...
export function generateScoresHTML(records: JsonObject, sex: string): string {
  ...
  const nonRiskScore = (totalResponsesScore - riskScore * 6) / 28;
  ...
  const html =
    ...
    `<tr>
                      ...
                      <td><p>` +
    parseFloat(subjectiveScore.toFixed(2)) +
    `/4</p></td>
                      <td><p>` +
    (sex === `M` ? `1.4` : `1.84`) +
    `</p></td>
                    ...
                    <tr>
                      ...
                      <td><p>` +
    parseFloat(operationScore.toFixed(2)) +
    `/4</p></td>
                      <td><p>` +
    (sex === `M` ? `1.29` : `1.3`) +
    `</p></td>
                    ...
                    <tr>
                      <td><p>Sintomi</p></td>
                      <td><p>` +
    parseFloat(symptomsScore.toFixed(2)) +
    `/4</p></td>
                      <td><p>` +
    (sex === `M` ? `1.3` : `1.43`) +
    `</p></td>
    ...
    `</p></td>
                    ...
                    <tr>
                      ...
                      <td><p>` +
    parseFloat(nonRiskScore.toFixed(2)) +
    `/4</p></td>
                      <td><p>` +
    (sex === `M` ? `1.27` : `1.42`) +
    `</p></td>
