...
export function generateScoresHTML(records: JsonObject): string
{
  ...
  const avoidanceScore = scoreJSON.avoidanceScore as number;
  const iperarousalScore = scoreJSON.iperarousalScore as number;
  const intrusivenesScore = scoreJSON.intrusivenesScore as number;

  const score = avoidanceScore + iperarousalScore + intrusivenesScore;
              ...
              <td>
                <table class="risultati">
                  ...
                  <tbody>` +
                    ...
                    // Punteggi
                   `<tr>
                      <td><p>Intrusività</p></td>
                      <td><p>` + intrusivenesScore + `/20</p></td>
                      <td><p>/</p></td>
                    </tr>

                    <tr>
                      <td><p>Evitamento</p></td>
                      <td><p>` + avoidanceScore + `/20</p></td>
                      <td><p>/</p></td>
                    </tr>

                    <tr>
                      <td><p>Iperarousal</p></td>
                      <td><p>` + iperarousalScore + `/20</p></td>
                      <td><p>/</p></td>
                    </tr>
