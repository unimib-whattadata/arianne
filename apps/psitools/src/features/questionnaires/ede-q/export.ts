...
export function generateResponsesHTML(records: JsonObject): string
{
  ...
  for(let i = 1; i <= 12; i++)
  {
    ...
    html +=  `<tr>
               ...
               `<td>` + risposte1[risposta] + `</td>` +   // Risposta
             `</tr>`;
  }
  ...
  for(let i = 19; i <= 20; i++)
  {
    ...
    html +=  `<tr>
                <td>` + (i) + `.</td>` +                              // #
               `<td>` + QUESTIONS[i-1].text + `</td>` +               // Item
               `<td>` + QUESTIONS[i-1].options[risposta] + `</td>` +  // Risposta
             `</tr>`;
  }
  ...
  for(let i = 21; i <= 28; i++)
  {
    ...
    html +=  `<tr>
                <td>` + (i) + `.</td>` +                  // #
               `<td>` + QUESTIONS[i-1].text + `</td>` +   // Item
               `<td>` + risposte2[risposta] + `</td>` +   // Risposta
             `</tr>`;
  }
