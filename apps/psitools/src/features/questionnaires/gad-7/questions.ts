export const INSTRUCTIONS =
  'Nelle ultime 2 settimane, con quale frequenza ti hanno dato fastidio ciascuno dei seguenti problemi?';
...
export const QUESTIONS = [
  ...
  'Preoccuparsi troppo su varie cose',
  'Avere difficoltà a rilassarsi',
  'Essere talmente irresoluto/a da far fatica a stare seduto/a fermo/a',
