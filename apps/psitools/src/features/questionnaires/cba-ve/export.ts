...
export function generateResponsesHTML(records: JsonObject): string
{
  ...
  for(let i = 1; i <= 40; i++)
  {
    html +=  `<tr>
                <td>` + (i) + `.</td>` +                                                // #
               `<td>` + QUESTIONS[0].questions[i-1].text + `</td>` +                    // Item
  ...
  for(let i = 41; i <= 66; i++)
  {
    html +=  `<tr>
                <td>` + (i) + `.</td>` +                                                // #
               `<td>Mi sono sentito ` + QUESTIONS[1].questions[i-41].text + `</td>` +   // Item
               `<td>` + risposte[parseInt(response[`item-` + i] as string)] + `</td>` + // Risposta
             `</tr>`;
  }
  ...
  for(let i = 67; i <= 80; i++)
  {
    html +=  `<tr>
                <td>` + (i) + `.</td>` +                                                // #
               `<td>Ho avuto ` + QUESTIONS[2].questions[i-67].text + `</td>` +        // Item
               `<td>` + risposte[parseInt(response[`item-` + i] as string)] + `</td>` + // Risposta
             `</tr>`;
  }
              ...
              <td>
                <table class="risultati">
                  ...
                  <tbody>` +
                    ...
                    // Punteggi
                   `<tr>
                      <td>` + (scores.ansia as string) + `</td>
                      <td>` + (scores.benessere as string) + `</td>
                      <td>` + (scores.cambiamento as string) + `</td>
                      <td>` + (scores.depressione as string) + `</td>
                      <td>` + (scores.disagio as string) + `</td>
                    </tr>
...
export function generateCSV(records: JsonObject): string
{
  ...
  {
    csv +=  (i) + `,"` +                                // #
            QUESTIONS[0].questions[i-1].text + `",` +   // Item
  ...
  {
    csv +=  (i) + `,` +                                                       // #
           `"Mi sono sentito ` + QUESTIONS[1].questions[i-41].text + `",` +   // Item
            (response[`item-` + i] as string) + `\n`                          // Risposta
  }
  ...
  {
    csv +=  (i) + `,` +                                               // #
           `"Ho avuto ` + QUESTIONS[2].questions[i-67].text + `",` +  // Item
            (response[`item-` + i] as string) + `\n`                  // Risposta
  }
