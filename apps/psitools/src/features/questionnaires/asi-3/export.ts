...
export function generateScoresHTML(records: JsonObject): string {
  ...
  const socialFearScore = scoreJSON.socialFearScore as number;
  const physicalFearScore = scoreJSON.physicalFearScore as number;
  const lossOfControlFearScore = scoreJSON.lossOfControlFearScore as number;

  const score = socialFearScore + physicalFearScore + lossOfControlFearScore;
  ...
  const html =
    ...
    // Punteggi
    `<tr>
                      <td><p>Timore sensazioni fisiche</p></td>
                      <td><p>` +
    physicalFearScore +
    `/32</p></td>
                    </tr>
                    ...
                    <tr>
                      <td><p>Timore perdita controllo</p></td>
                      <td><p>` +
    lossOfControlFearScore +
    `/16</p></td>
                    </tr>

                    <tr>
                      <td><p>Timore di ostracismo sociale</p></td>
                      <td><p>` +
    socialFearScore +
    `/16</p></td>
                    </tr>
