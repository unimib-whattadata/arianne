...
const risposte =  [ `Non mi è mai accaduto`,
                ...
                <table class="risultati">
                  ...
                  <tbody>` +
                   ...
                   `<tr>
                      ...
                      <td><p>` + depression + `/42</p></td>
                      <td><p>14</p></td>
                      <td><p>` + (depression < 10 ? `Normale` : (depression < 14 ? `Lieve` : (depression < 21 ? `Moderata` : (depression < 28 ? `Grave` : `Molto grave`)))) + `</p></td>
                    </tr>

                    <tr>
                      <td><p>Ansia</p></td>
                      <td><p>` + anxiety + `/42</p></td>
                      <td><p>10</p></td>
                      <td><p>` + (anxiety < 8 ? `Normale` : (anxiety < 10 ? `Lieve` : (anxiety < 15 ? `Moderata` : (anxiety < 20 ? `Grave` : `Molto grave`)))) + `</p></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><p>` + stress + `/42</p></td>
                      <td><p>19</p></td>
                      <td><p>` + (stress < 15 ? `Normale` : (stress < 19 ? `Lieve` : (stress < 26 ? `Moderata` : (stress < 34 ? `Grave` : `Molto grave`)))) + `</p></td>
                    </tr>
