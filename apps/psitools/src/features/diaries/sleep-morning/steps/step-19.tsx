            ...
            <div className="grid grid-cols-2 gap-x-10 rounded-sm bg-white px-4 py-6">
              ...
              <div className="relative col-start-2 mt-2" ref={sliderRef}>
                <div
                  ...
                  style={{ left: getThumbPosition(tired) }}
                  onMouseDown={(_e) => {
                ...
                >
                  <span className="text-white-900 font-bold">{tired}</span>
                </div>
                ...
                <FormControl>
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #2D7C35 0%, #2D7C35 ${((tired - 1) / 9) * 100}%, #E0E0E0 ${((tired - 1) / 9) * 100}%, #E0E0E0 100%)`,
                    }}
                  />
                </FormControl>
              </div>
