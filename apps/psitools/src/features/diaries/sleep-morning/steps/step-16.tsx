...
export default function Step16() {
  ...
  const [disturbe, setDisturbe] = useState(5);
          ...
          <FormItem>
            <div className="grid grid-cols-2 gap-x-10 rounded-sm bg-white px-4 py-6">
              <FormLabel className="col-span-1 text-base font-normal">
                Indica quanto è stato disturbato il tuo sonno questa notte
              </FormLabel>
              ...
              <div className="relative col-start-2 mt-2" ref={sliderRef}>
                <div
                  ...
                  style={{ left: getThumbPosition(disturbe) }}
                  onMouseDown={(_e) => {
                ...
                >
                  <span className="text-white-900 font-bold">{disturbe}</span>
                </div>
                ...
                <FormControl>
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #2D7C35 0%, #2D7C35 ${((disturbe - 1) / 9) * 100}%, #E0E0E0 ${((disturbe - 1) / 9) * 100}%, #E0E0E0 100%)`,
                    }}
                  />
                </FormControl>
              </div>
