...
export default function Step20() {
  ...
  const [drowsiness, setDrowsiness] = useState(5);
          ...
          <FormItem>
            <div className="grid grid-cols-2 gap-x-10 rounded-sm bg-white px-4 py-6">
              <FormLabel className="col-span-1 text-base font-normal">
                ...
                livello di sonnolenza, stanchezza e fatica nel rimanere sveglio
              </FormLabel>
              ...
              <div className="relative col-start-2 mt-2" ref={sliderRef}>
                <div
                  ...
                  style={{ left: getThumbPosition(drowsiness) }}
                  onMouseDown={(_e) => {
                ...
                >
                  <span className="text-white-900 font-bold">{drowsiness}</span>
                </div>
                ...
                <FormControl>
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #2D7C35 0%, #2D7C35 ${((drowsiness - 1) / 9) * 100}%, #E0E0E0 ${((drowsiness - 1) / 9) * 100}%, #E0E0E0 100%)`,
                    }}
                  />
                </FormControl>
              </div>
