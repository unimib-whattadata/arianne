...
export default function Step1() {
  ...
  const [tense, setTense] = useState(5);
          ...
          <FormItem>
            <div className="grid grid-cols-2 gap-x-10 rounded-sm bg-white px-4 py-6">
              <FormLabel className="col-span-1 text-base font-normal">
                Indica quanto ti sei sentito tesə e nervosə durante la giornata,
                a causa dei tuoi problemi di sonno
              </FormLabel>
              ...
              <div className="relative col-start-2 mt-2" ref={sliderRef}>
                <div
                  ...
                  style={{ left: getThumbPosition(tense) }}
                  onMouseDown={(_e) => {
                ...
                >
                  <span className="text-white-900 font-bold">{tense}</span>
                </div>
                ...
                <FormControl>
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #2D7C35 0%, #2D7C35 ${((tense - 1) / 9) * 100}%, #E0E0E0 ${((tense - 1) / 9) * 100}%, #E0E0E0 100%)`,
                    }}
                  />
                </FormControl>
              </div>
