  ...
  return (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <BreadcrumbLink
            href={`/pazienti/${userId}/assegnazioni/diari/cognitivo-comportamentale`}
          >
        ...
        <BreadcrumbItem>
          <BreadcrumbLink
            href={`/pazienti/${userId}/assegnazioni/diari/cognitivo-comportamentale/assegnazione`}
          >
            Assegnazione
          </BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbPage>Nuova compilazione</BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
  );
