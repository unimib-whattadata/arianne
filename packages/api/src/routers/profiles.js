...
exports.profileRouter = (0, trpc_1.createTRPCRouter)({
    get: trpc_1.protectedProcedure
        .input(zod_1.default.object({ id: zod_1.default.string().uuid() }).optional())
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    profileId = (_c = input === null || input === void 0 ? void 0 : input.id) !== null && _c !== void 0 ? _c : ctx.user.id;
                    return [4 /*yield*/, ctx.db.query.profiles.findFirst({
                            where: function (t, _a) {
                                var eq = _a.eq;
                                return eq(t.id, profileId);
                            },
