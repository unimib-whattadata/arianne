...
var events_1 = require("@arianne/db/schemas/events");
var drizzle_orm_1 = require("drizzle-orm");
var trpc_1 = require("../trpc");
exports.eventRouter = (0, trpc_1.createTRPCRouter)({
    create: trpc_1.protectedProcedure
        .input(events_1.EventsCreateSchema)
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var therapistId, event;
        var input = _b.input, ctx = _b.ctx;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    therapistId = ctx.user.id;
                    return [4 /*yield*/, ctx.db.insert(events_1.events).values(__assign({ therapistId: therapistId }, input))];
                case 1:
                    event = _c.sent();
    ...
    update: trpc_1.protectedProcedure
        .input(events_1.EventsUpdateSchema)
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var therapistId, event;
        var input = _b.input, ctx = _b.ctx;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ctx.db
                            ...
                            .set(__assign({ therapistId: therapistId }, input))
                            .where((0, drizzle_orm_1.eq)(events_1.events.id, input.id))
                            .returning()
    ...
    delete: trpc_1.protectedProcedure
        .input(events_1.EventsDeleteSchema)
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var event;
        var input = _b.input, ctx = _b.ctx;
        return __generator(this, function (_c) {
    ...
    getAll: trpc_1.protectedProcedure.query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    userId = ctx.user.id;
                    return [4 /*yield*/, ctx.db.query.events.findMany({
                            where: function (t, _a) {
                                var eq = _a.eq;
                                return eq(t.therapistId, userId);
                            },
                            with: {
                                participants: {
                                    with: {
    ...
    getAllForPatients: trpc_1.protectedProcedure.query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var userId;
        var ctx = _b.ctx;
        return __generator(this, function (_c) {
            switch (_c.label) {
