...
var createClient = function (awaitableCookieStore) { return __awaiter(void 0, void 0, void 0, function () {
    var cookieStore;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, awaitableCookieStore];
            case 1:
                cookieStore = _a.sent();
                return [2 /*return*/, (0, ssr_1.createServerClient)(supabaseUrl, supabaseKey, {
                        cookies: {
                            getAll: function () {
