...
const DETAIL1_OPTIONS = [
  { value: 0, label: "Abbiamo visioni molto diverse su temi importanti come figli, carriera, luogo di vita" },
  { value: 1, label: "Le nostre divergenze generano tensioni o conflitti frequenti" },
  { value: 2, label: "Sento che stiamo crescendo in direzioni diverse e incompatibili" },
  { value: 3, label: "I nostri obiettivi futuri sembrano sempre meno conciliabili" },
  { value: 4, label: "Faccio fatica a sentirmi supportato/a nelle mie scelte o aspirazioni personali" },
];
export const CoupleDetail5 = () => {
...
Senti che tu e il tuo partner avete progetti di vita o valori molto diversi?
           </FormLabel>
