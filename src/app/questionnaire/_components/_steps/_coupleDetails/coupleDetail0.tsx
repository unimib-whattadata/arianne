...
const DETAIL1_OPTIONS = [
  { value: 0, label: "Mi sento spesso frainteso/a o non ascoltato/a dal mio partner" },
  { value: 1, label: "Evito di esprimere i miei pensieri o bisogni per paura di discussioni" },
  { value: 2, label: "Quando parlo, il mio partner tende a interrompermi o a minimizzare ciò che dico" },
  { value: 3, label: "Le conversazioni importanti sfociano spesso in litigi o silenzi " },
