...
const DETAIL1_OPTIONS = [
  { value: 0, label: "Mi sento spesso in ansia, preoccupato/a, anche senza un motivo preciso" },
  { value: 1, label: "Ho difficoltà a controllare le mie preoccupazioni, anche se mi sembrano eccessive" },
  { value: 2, label: "Avverto sintomi fisici come tensione muscolare, tachicardia, respiro corto o sudorazione " },
  { value: 3, label: "Evito situazioni sociali o lavorative perché mi fanno sentire a disagio o sotto pressione " },
  { value: 4, label: "Ho attacchi improvvisi di ansia intensa che arrivano all’improvviso " },
  { value: 5, label: "Provo una sensazione di paura in diverse situazioni e/o in modo frequente " },
];
